...
@admin.register(Punchline)
class PunchlineAdmin(admin.ModelAdmin):
    list_display = ('id', 'modified', 'author_object', 'teaser')
    list_display_links = ('id',)
    # list_select_related = ('author_object',)
    search_fields = (
        'author_object__first_name',
        'author_object__last_name',
        # 'author_object__nickname',
        'text',
    )
    date_hierarchy = 'created'
    ordering = ('-modified',)
